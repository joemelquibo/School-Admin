                    ...
                    <tbody>
                        {details.map((item) => (
                            <tr key={item.enroll_id}>
                                ...
                                <td>{item.suboffid}</td>
                                <td>
                                    <button className="w3-button w3-small w3-yellow" onClick={() => prepareEdit(item)}>&#9998;</button>
                                    <button className="w3-button w3-small w3-red" onClick={() => handleDelete(item.enroll_id)}>&times;</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
                    ...
                    <div className='w3-container w3-padding'>
                        <form onSubmit={handleSubmit}>
                            ...
                            <p className='w3-right'>
                                <button type='button' className='w3-button w3-red' onClick={() => document.getElementById('enrollmentmodal').style.display = 'none'}>CANCEL</button>
